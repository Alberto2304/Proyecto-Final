...
<html lang="es" dir="ltr">
  ...
  <body>
      ...
      <div class="row">
        <div class="col-md-4 col-lg-4">
          <div class="card m-auto py-2" style="width: 18rem;">
               <img src="imgs/lgk11.jpg" class="card-img-top" alt="...">
              <div class="card-body">
        ...
        <div class="col-md-4 col-lg-4">
          <div class="card m-auto py-2" style="width: 18rem;">
               <img src="imgs/huawei79.jpg" class="card-img-top" alt="...">
              <div class="card-body">
        ...
        <div class="col-md-4 col-lg-4">
          <div class="card m-auto py-2" style="width: 18rem;">
               <img src="imgs/cellg.jpg" class="card-img-top" alt="...">
              <div class="card-body">
    ...
    <div class="container text-center my-5">
      <img src="imgs/mejores.jpg" class="img-fluid"  alt="Responsive image">
    </div>
